...
public class hospitalService {
	...
	public String insertHospitals(@FormParam("Hospital_ID") String Hospital_ID,
	...
	{
		String output = hospitalObj.insertHospital(Hospital_ID, Hospital_Name, Hospital_Address, Hospital_City, Hospital_Phone, Hospital_Email, Hospital_Description, Open_Hours);
		return output;
	}
